...
const CGIDrawer = ({ isModalOpen, setIsModalOpen }) => {
    ...
    const getItems = (panelStyle) => [{
        key: '1',
        label: <>
            <h4>{`How to upload file from Zerodha`}</h4>
        </>,
        children: (
            <>
                <div className='mt-3 ms-5'>
                    <ol>
                        <li>Go to Zerodha and login to your account</li>
                        <li>
        ...
        >
            ...
            <div className="mt-4 mb-5">
                ...
                <div className='d-flex flex-wrap gap-3 text-decoration-underline mt-4'>
                    <Link href="#">Download Sample Zerodha report</Link>
                    <Link href="#">Download Sample Zerodha report</Link>
                </div>
            </div>
